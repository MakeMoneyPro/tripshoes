            ...
            {{ csrf_field() }}
                <div class="box-body">
                    ...
                    <div class="form-group{{ $errors->has('mobile_phone') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="mobile_phone" name="mobile_phone" placeholder="Phone" value="{{old('mobile_phone')}}">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">{{trans('lang_admin_manager_user.create_user')}}</button>
                    </div>
                </div>
            </form>
        </div>
